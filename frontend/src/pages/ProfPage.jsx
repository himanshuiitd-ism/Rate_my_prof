            ...
            {prof.department && (
              <div className="profile-dept">
                <svg
                  ...
                  strokeWidth="2.5"
                >
                  <path d="M12 11h.01M12 7h.01M12 15h.01M12 19h.01M8 11h.01M8 7h.01M8 15h.01M8 19h.01M16 11h.01M16 7h.01M16 15h.01M16 19h.01M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2z" />
                </svg>
                {prof.department}
              </div>
            )}
